...
ESPectroBase_BMP280::ESPectroBase_BMP280() {
    //do nothing
}
...
*/
char ESPectroBase_BMP280::begin(int sdaPin, int sclPin) {
    Wire.begin(sdaPin, sclPin);
    return (readCalibration());
}

char ESPectroBase_BMP280::begin() {
...
char ESPectroBase_BMP280::readCalibration() {
...
*/
char ESPectroBase_BMP280::readInt(char address, double &value) {
...
char ESPectroBase_BMP280::readUInt(char address, double &value) {
...
char ESPectroBase_BMP280::readBytes(unsigned char *values, char length) {
    char x;

    Wire.beginTransmission(ESPECTRO_BMP280_ADDR);
    Wire.write(values[0]);
    error = Wire.endTransmission();
    if (error == 0) {
        Wire.requestFrom(ESPECTRO_BMP280_ADDR, length);
...
*/
char ESPectroBase_BMP280::writeBytes(unsigned char *values, char length) {
    Wire.beginTransmission(ESPECTRO_BMP280_ADDR);
...
short ESPectroBase_BMP280::getOversampling(void) {
    return oversampling;
}

char ESPectroBase_BMP280::setOversampling(short oss) {
    oversampling = oss;
    return (1);
}
...
*/
char ESPectroBase_BMP280::startMeasurment(void) {
...
*/
char ESPectroBase_BMP280::getUnPT(double &uP, double &uT) {
...
*/
char ESPectroBase_BMP280::getTemperatureAndPressure(double &T, double &P) {
    double uT;
    double uP;
...
*/
char ESPectroBase_BMP280::calcTemperature(double &T, double &adc_T)
//
{
...
*/
char ESPectroBase_BMP280::calcPressure(double &P, double uP) {
    //char result;
    double var1, var2;
...
double ESPectroBase_BMP280::sealevel(double P, double A)
...
double ESPectroBase_BMP280::altitude(double P, double P0)
...
char ESPectroBase_BMP280::getError(void)
